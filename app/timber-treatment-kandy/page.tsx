...
const localSchema = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Vacuum Pressure Impregnation (VPI)', description: 'Full-penetration Boron Borax treatment at 10 bar for pest and fungal protection. 10-year warranty. Delivery to Kandy available.' } },
...
const SERVICES = [
  ...
  },
  {
    ...
    desc: 'Kandy\'s humid highland climate accelerates fungal growth and timber degradation if wood is not properly treated. Our VPI process drives 5% Boron Borax preservative deep into the wood core at 10 bar (145 PSI), providing long-lasting protection against termites, wood borers, and fungal decay — even after the timber is cut and machined. Backed by a 10-year warranty.',
    details: [
